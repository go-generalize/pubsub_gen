...
func Main() {
	...
	var err error
	pubsubBoilerplateTmpl, err = misc.GetTemplate("/boilerplate/pubsub_boilerplate.go.gpl")
	if err != nil {
		log.Fatalf("pubsub_boilerplate template create failed: %v", err)
	}

	functionBoilerplateTmpl, err = misc.GetTemplate("/boilerplate/function_boilerplate.go.tpl")
	if err != nil {
